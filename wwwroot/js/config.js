...
// ==================== 倾斜摄影配置（新增，不修改原有代码）====================
window.TILTED_CONFIG = {
  enabled: true,
  s3cPath: "./tilted_data/Production_osgb_cgcs2000.s3c", // 指向你的 .s3c 文件
  autoZoom: true,
  debug: false,
  // 重要：因为是 OSGB 格式，必须用 addS3MTilesLayerByScp，不能用 Cesium3DTileset
  layerType: "S3CTiles" // 标记用 SuperMap 专用图层
};